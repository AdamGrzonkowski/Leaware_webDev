...
namespace Sklep_Leaware.Controllers
{
    ...
    public partial class ManageController : Controller
    {
        ...
        public virtual async Task<ActionResult> LinkLoginCallback()
        {
            ...
            if (loginInfo == null)
            {
                return RedirectToAction(RedirectToAction(MVC.Manage.ManageLogins(ManageMessageId.Error)));
            }
            var result = await UserManager.AddLoginAsync(User.Identity.GetUserId(), loginInfo.Login);
            return result.Succeeded ? RedirectToAction(MVC.Manage.ManageLogins()) : RedirectToAction(MVC.Manage.ManageLogins(ManageMessageId.Error));
        }
